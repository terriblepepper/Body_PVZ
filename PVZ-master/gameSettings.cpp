...
SettingsDialog::SettingsDialog(QWidget* parent) : QDialog(parent)
{
    ...
    // 手势控制设置
    gestureControlCheckBox = new QCheckBox("启用手势控制", this);
    gestureControlCheckBox->setChecked(GestureControl);
    mainLayout->addWidget(gestureControlCheckBox);
...
void SettingsDialog::applySettings()
{
    ...
    bool gestureControl = gestureControlCheckBox->isChecked();

    emit settingsChanged(volume, volume2, difficulty, fps, gestureControl);
    accept();
}
